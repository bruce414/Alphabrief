...
export function ResearchSpace(props: IconProps) {
  return (
    <svg
      width="16"
      height="16"
...
/** Outline bookmark (pin / save): rounded top, V notch at bottom */
export function Pin(props: IconProps) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M10.5 3h3C14.88 3 16 4.12 16 5.5V18.6L12 15.25 8 18.6V5.5C8 4.12 9.12 3 10.5 3z" />
    </svg>
  );
}
...
/** Four-point sparkle + small plus (top-right) + dot (bottom-left) */
export function Agent(props: IconProps) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M12 4.5l1.35 4.35 4.65.35-3.55 3.05 1.1 4.55L12 14.9 8.45 17.8l1.1-4.55-3.55-3.05 4.65-.35z" />
      <line x1="17.4" y1="5.2" x2="17.4" y2="8.2" />
      <line x1="15.9" y1="6.7" x2="18.9" y2="6.7" />
      <circle cx="6.35" cy="17.35" r="1.15" fill="currentColor" stroke="none" />
    </svg>
  );
}
...
export function Sources(props: IconProps) {
  return (
    <svg
      width="16"
      height="16"
...
export function Brief(props: IconProps) {
  return (
    <svg
      width="16"
      height="16"
...
export function PinBoard(props: IconProps) {
  return (
    <svg
      width="16"
      height="16"
...
export function ZoomMinus(props: IconProps) {
  return (
    <svg
      width="14"
      height="14"
...
export function ZoomPlus(props: IconProps) {
  return (
    <svg
      width="14"
      height="14"
